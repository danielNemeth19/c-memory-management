...
void test_snek_array_set_false(void) {
    ...
    free(obj_int);
    free(obj_float);
    free(obj_arr->data.v_array.elements);
    free(obj_arr);
}
...
void test_snek_add_vector3(void) {
    ...
    free(vec1);
    free(vec2);
    free(vec_sum->data.v_vector3.x);
    free(vec_sum->data.v_vector3.y);
    free(vec_sum->data.v_vector3.z);
    free(vec_sum);
}
